import argparse
from Experiment.test import experiment_Syn, experiment_Real
import warnings
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_path', type=str, default='./weights/pretrained_parameter.pth',
                        help='Output path')
    parser.add_argument('--GPU_id', type=str, default='2', help='gpu id to execute code when gpu is true')
    ...
    # parser.add_argument('--seed', type=int, default=0,help='test seed')
