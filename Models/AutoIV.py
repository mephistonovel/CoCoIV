...
def generate_IV(train_data_full,test_data_full, i,args):
    # data.numpy()
    ### data preprocessing ### 
    x_train, t_train, y_train = train_data_full
    ...
    prep_data = np.concatenate([x_train,t_train.reshape(-1,1), y_train.reshape(-1,1)],axis=1)
    ...
    # train_dict['epochs'] = 1000 # 일반
    train_dict['epochs'] = 100 # real
